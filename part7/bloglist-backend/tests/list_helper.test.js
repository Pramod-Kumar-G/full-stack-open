...
describe('total likes', () => {
  ...
  test('of a bigger list is calculated right', () => {
    assert.strictEqual(listHelper.totalLikes(listWithMultipleBlog), 36)
  })
})
...
describe('favourite blog', () => {
  ...
  test('of a bigger list is calculated right', () => {
    assert.deepStrictEqual(listHelper.favoriteBlog(listWithMultipleBlog), {
      _id: '5a422b3a1b54a676234d17f9',
      title: 'Canonical string reduction',
      author: 'Edsger W. Dijkstra',
      url: 'http://www.cs.utexas.edu/~EWD/transcriptions/EWD08xx/EWD808.html',
...
describe('most blog author', () => {
  ...
  test('of a bigger list is calculated right', () => {
    assert.deepStrictEqual(listHelper.mostBlogs(listWithMultipleBlog), {
      author: 'Robert C. Martin',
      blogs: 3,
    })
  })
...
describe('most likes author', () => {
  ...
  test('of a bigger list is calculated right', () => {
    assert.deepStrictEqual(listHelper.mostLikes(listWithMultipleBlog), {
      author: 'Edsger W. Dijkstra',
      likes: 17,
    })
  })
